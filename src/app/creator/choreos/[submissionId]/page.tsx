...
export default function CreatorChoreoDetailPage() {
  ...
  return (
    <section className="tab-screen-enter">
      <div className="mb-5 flex items-center justify-between gap-3">
        ...
        <Link href="/creator/choreos" className="rounded-xl border border-white/20 bg-white/5 px-4 py-2 text-sm text-white">
          Back
        </Link>
      </div>
