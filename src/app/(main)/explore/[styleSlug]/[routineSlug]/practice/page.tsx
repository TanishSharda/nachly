...
const CalibrationScreen = dynamic(() => import("@/components/practice/CalibrationScreen"), { ssr: false });
...
const SessionResults = dynamic(() => import("@/components/practice/SessionResults"), { ssr: false });
