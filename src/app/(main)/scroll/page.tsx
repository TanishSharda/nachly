          ...
          >
            <div className="flex flex-wrap items-end justify-between gap-6">
              ...
              <div className="flex flex-wrap gap-2 text-[10px] font-bold uppercase tracking-[0.16em] text-white">
                <Link href="/feed" className="rounded-full border border-white/10 bg-white/5 px-4 py-2 hover:bg-white/10">
                  All feed
                </Link>
                <Link href="/collections" className="rounded-full border border-white/10 bg-white/5 px-4 py-2 hover:bg-white/10">
                  Collections
                </Link>
                <Link href="/profile/me" className="rounded-full bg-[#F3B2AB] px-4 py-2 text-black hover:brightness-105">
                  Profile
                </Link>
              </div>
            </div>
